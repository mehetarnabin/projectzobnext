...
import { MdWork, MdLocationOn, MdBusiness, MdAttachMoney, MdInsertDriveFile, MdUpload, MdVideoLibrary, MdAccessTime, MdCategory } from "react-icons/md";
...
const JobStep1 = ({ onNext, initialData = {} }) => {
  ...
  return (
    ...
    <form onSubmit={handleNext} className="space-y-6">
        ...
        {/* Video URL */}
        <div>
            <label className="block font-medium text-gray-700 mb-1">Optional Video URL</label>
            <div className="flex items-center border border-gray-300 rounded-md px-3">
            <MdVideoLibrary className="text-gray-400 text-xl" />
            <input
                type="url"
                name="videoUrl"
